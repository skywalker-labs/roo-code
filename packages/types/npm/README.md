...
const extension = vscode.extensions.getExtension<RooCodeAPI>("SkywalkerLabs.roo-cline")
...
**NOTE:** To ensure that the `SkywalkerLabs.roo-cline` extension is activated before your extension, add it to the `extensionDependencies` in your `package.json`:

```json
"extensionDependencies": ["SkywalkerLabs.roo-cline"]
```
