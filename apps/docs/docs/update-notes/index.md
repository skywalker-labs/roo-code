...
If you want to live on the edge and try things out before it's released, we have a [Nightly channel](https://marketplace.visualstudio.com/items?itemName=SkywalkerLabs.roo-code-nightly).
